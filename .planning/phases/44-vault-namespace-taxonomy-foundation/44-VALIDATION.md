...
| 44-02-01 | 02 | 1 | VAULT-04 | T-44-02-01 | inbox/ embedded but excluded from BOTH warm tiers | unit (tdd) | `cd sentinel-core && pytest tests/test_vault_sweeper.py -k "skip or inbox" -q && cd sentinel-core && pytest tests/test_recall.py -k inbox_gap -q` | ⚠️ 2 flips + 1 new | ⬜ pending |
